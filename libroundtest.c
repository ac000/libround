...
int main(int argc, char **argv)
{
	...
	printf("floor            : %f --> %f\n", atof(argv[1]),
        ...
        printf("round            : %f --> %f\n", atof(argv[1]),
                                        round(atof(argv[1]) * rf) / rf);
        printf("round_half_up    : %f --> %f\n", atof(argv[1]),
                                        round_half_up(atof(argv[1]), rf));
        printf("round_half_up0   : %f --> %f\n", atof(argv[1]),
                                        round_half_up0(atof(argv[1]), rf));
        printf("round_half_down  : %f --> %f\n", atof(argv[1]),
                                        round_half_down(atof(argv[1]), rf));
        printf("round_half_down0 : %f --> %f\n", atof(argv[1]),
                                        round_half_down0(atof(argv[1]), rf));
        printf("round_half_even  : %f --> %f\n", atof(argv[1]),
                                        round_half_even(atof(argv[1]), rf));
